<?php
    ...
    while($row = $STH->fetch()){
            $user .= '
                ...
                <div class="user-avatar" style=" background-image: url(./assets/media/'.$row["photo"].');"></div>
   ...
   $STH = $connect->query("SELECT * FROM `history` WHERE `user_id`=".$_SESSION['user_id']." ORDER BY `created_at` DESC");
    $STH->execute();
...
<body>
    ...
    <section>
        <div class="container user_profile d-flex flex-wrap ">
            ...
            <!-- Блок с полезной пользователю информацией -->
            <div class="content">
           
                <div class="history">
                    <a class="title_history" href="./history_page.php">История ></a>
                    <div class="slider">
                ...
                <div class="favorite">
                    <a class="title_favorite" href="./favourite_page.php">Любимое ></a>
                    <div class="slider">
                         <?= $fav_film ?>
                    </div>
                </div>
